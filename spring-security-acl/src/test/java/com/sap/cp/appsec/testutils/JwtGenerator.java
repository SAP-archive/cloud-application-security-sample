package com.sap.cp.appsec.testutils;
...
public class JwtGenerator {
     ...
     *
     * @param attributeName   the attribute name that should be part of the token
     ...
     *
     * @param keyId the value of the signed jwt token header "keyId"
     * @return the JwtGenerator itself
     */
    ...
    public static Jwt convertTokenToOAuthJwt(String token) throws java.text.ParseException {
        ...
        return new Jwt(parsedJwt.getParsedString(), jwtClaimsSet.getIssueTime().toInstant(), jwtClaimsSet.getExpirationTime().toInstant(), headers, jwtClaimsSet.getClaims());
    }
}
